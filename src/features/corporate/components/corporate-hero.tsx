...
export async function CorporateHero() {
  ...
  return (
    <section
      ...
      className={`${fontCorporateDisplay.variable} ${styles.section} relative isolate mt-[calc(var(--h-navbar)*-1)] overflow-hidden bg-secondary text-white`}
    >
      <Image
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-7xl flex-col gap-12 px-4 pt-[calc(var(--h-navbar)+3rem)] pb-12 sm:px-6 md:pt-[calc(var(--h-navbar)+4rem)] md:pb-16 lg:min-h-[calc(100vh-2rem)] lg:justify-between lg:px-8 lg:pt-[calc(var(--h-navbar)+5rem)] lg:pb-20">
