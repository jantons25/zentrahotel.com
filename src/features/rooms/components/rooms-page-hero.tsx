...
export async function RoomsPageHero() {
  ...
  return (
    <section
      ...
      className={`${fontRoomsDisplay.variable} ${styles.section} relative isolate mt-[calc(var(--h-navbar)*-1)] overflow-hidden bg-secondary text-white`}
    >
      <Image
