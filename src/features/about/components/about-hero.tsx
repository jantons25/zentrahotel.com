...
export function AboutHero() {
  return (
    <section
      aria-label="Nosotros · Zentra Hotel"
    ...
    >
      ...
      />
      <div
        className="pointer-events-none absolute inset-0 -z-10 bg-gradient-to-b from-secondary/25 via-transparent to-secondary/40"
        aria-hidden="true"
      />
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-7xl flex-col gap-12 px-4 pt-32 pb-12 sm:px-6 md:pt-40 md:pb-16 lg:px-8 lg:pt-44 lg:pb-20">
        <div className="grid gap-12 lg:grid-cols-12 lg:items-end lg:gap-16">
          <div className="lg:col-span-8">
            ...
            >
              Zentra nació con una convicción simple: viajar por trabajo o
              descanso no debería sentirse impersonal. Combinamos ubicación
              privilegiada, diseño cálido y un equipo humano que trata cada
              estadía como si fuera la primera.
            </p>

            <ul
              className={`${styles.reveal} mt-8 flex flex-wrap gap-2`}
              style={{ "--reveal-delay": "320ms" } as React.CSSProperties}
              aria-label="Sellos de Zentra"
            >
            ...
            >
              ...
              <a
                href={buildWhatsAppUrl(
                  "Hola, me gustaría conocer más sobre Zentra Hotel.",
                )}
                target="_blank"
                rel="noopener noreferrer"
