...
export function AboutExperience() {
  return (
    ...
    >
      <div
        className="pointer-events-none absolute -top-40 -right-24 size-[26rem] rounded-full bg-primary/15 blur-3xl"
        aria-hidden="true"
      />
      <div
        className="pointer-events-none absolute -bottom-32 -left-20 size-[22rem] rounded-full bg-secondary/10 blur-3xl"
        aria-hidden="true"
      />
      <Container className="relative">
        <div className="grid gap-12 lg:grid-cols-12 lg:items-center lg:gap-16">
          ...
          >
            <div
              className={`${styles.card} relative aspect-[4/5] w-full overflow-hidden rounded-[2rem] border border-secondary/10 bg-secondary/5 shadow-card`}
            >
              <Image
                src="/images/plaza/cowork-plaza-uno.webp"
                alt="Recepción cálida en Zentra Hotel."
                fill
                loading="lazy"
              ...
              <div className="absolute inset-x-6 bottom-6 flex flex-col gap-2 sm:inset-x-8 sm:bottom-8">
                ...
                <p className="font-[family-name:var(--font-about-display)] text-2xl font-light leading-tight text-white text-balance sm:text-[1.75rem]">
                  De la reserva al descanso, sin fricciones.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-7">
            ...
            >
              Simplificamos cada punto de contacto para que tu única preocupación
              sea disfrutar la ciudad. Así se ve una estadía Zentra:
            </p>
              ...
              {aboutSteps.map(({ number, icon: Icon, title, description }, index) => (
                ...
                >
                  ...
                  <article className="relative flex gap-5">
                    <span
                      className="relative z-10 grid size-12 shrink-0 place-items-center rounded-full bg-primary text-primary-foreground shadow-[0_10px_24px_rgba(185,188,49,0.35)]"
                      aria-hidden="true"
                    >
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-3">
                        ...
                        <Icon
                          className="hidden size-4 text-secondary/60 sm:block"
                          strokeWidth={1.75}
                          aria-hidden="true"
                        />
                      </div>
