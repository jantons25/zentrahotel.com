      ...
      <div className="flex flex-1 flex-col p-6">
        <div className="flex items-baseline justify-between gap-4">
          ...
          <p
            ...
            aria-label={`Descuento ${promotion.discount}`}
          >
            {promotion.discount}
          </p>
        </div>
        ...
        {promotion.code ? (
          <div className={`${styles.codeStrip} mt-6`}>
            ...
            <button
              ...
              aria-label={
                copied ? "Código copiado" : `Copiar código ${promotion.code}`
              }
            >
              {copied ? (
                <>
        ...
        {promotion.conditions.length > 0 ? (
          <ul className="mt-5 space-y-1.5">
            {promotion.conditions.map((condition) => (
              ...
              >
                <span
                  className="mt-1.5 size-1 shrink-0 rounded-full bg-secondary/30"
                  aria-hidden="true"
                />
                {condition}
              </li>
