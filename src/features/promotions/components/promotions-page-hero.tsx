...
export function PromotionsPageHero() {
  const total = promotions.length;

  return (
    <section
      aria-label="Bienvenida a promociones"
        ...
        <div className="max-w-4xl">
          ...
          >
            <span
              ...
              aria-hidden="true"
            />
            Ofertas vigentes · {total.toString().padStart(2, "0")}
          </p>
          ...
          >
            Larga estadía, workation, primer día de coworking. Elige la sede
            que te queda cerca y aprovecha la oferta con reserva directa.
            Todas incluyen Wi-Fi 5G y desayuno.
          </p>
        </div>
      </div>
    </section>
