  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-7xl flex-col gap-12 px-4 pt-32 pb-16 sm:px-6 md:pt-40 lg:min-h-[calc(100vh-2rem)] lg:px-8 lg:pt-44 lg:pb-24">
        <div className="grid gap-10 lg:grid-cols-12 lg:items-center lg:gap-16">
          <div className="lg:col-span-7">
            ...
            >
              ...
              Boutique hotel · Centro de Chiclayo
            </p>
            ...
            >
              ...
              <br />
              donde Chiclayo se{" "}
              <span className="italic font-normal text-primary">hace hogar.</span>
            </h1>
            ...
            >
              Un descanso curado en pleno centro histórico: habitaciones
              modernas, atención cercana y rituales pensados para que la ciudad
              se sienta tuya desde el primer minuto.
            </p>
        ...
        <ul
          className={`${styles.reveal} grid grid-cols-2 gap-3 rounded-[1.5rem] border border-white/15 bg-white/5 p-4 backdrop-blur sm:p-6 md:grid-cols-4 md:gap-6`}
          style={{ "--reveal-delay": "440ms" } as React.CSSProperties}
        >
          {stats.map(({ value, label }) => (
            <li key={label} className="flex flex-col gap-1">
              <p className="font-[family-name:var(--font-hero-display)] text-2xl font-normal leading-none text-white tracking-tight sm:text-3xl">
                {value}
              </p>
              <p className="text-[0.72rem] leading-snug text-white/70 sm:text-sm">
                {label}
              </p>
            </li>
          ))}
